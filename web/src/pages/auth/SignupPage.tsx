    ...
    <>
      ...
      <div className="text-center mb-6">
        ...
        <p className="text-sm text-muted leading-[22px] tracking-[-0.1px]">
          Welcome to Silo, your personal silo of wealth — isolated, safe, controlled by you
        </p>
      </div>
      ...
      <p className="mt-5 text-center text-sm text-muted leading-[22px] tracking-[-0.1px]">
      ...
      <p className="mt-3 text-center text-sm text-muted tracking-[-0.1px]">
